      ...
      >
        ...
        <div className="space-y-3">
          <Button 
            ...
            tooltip="Sign in securely with your Google account"
          >
          ...
          <Button 
            ...
            tooltip="Sign in securely with your Microsoft account"
          >
          ...
          <Button 
            ...
            tooltip="Sign in securely with your Facebook account"
          >
          ...
          <Button 
            ...
            tooltip="Sign in securely with your GitHub account"
          >
            <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
